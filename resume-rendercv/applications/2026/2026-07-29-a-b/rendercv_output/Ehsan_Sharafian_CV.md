# Ehsan Sharafian's CV

- Phone: +1 207 631 6979
- Email: [ehsan.sharafian@maine.edu](mailto:ehsan.sharafian@maine.edu)
- Location: Orono, ME
- Website: [ehsansharafian.com](https://ehsansharafian.com/)
- LinkedIn: [ehsan-sharafian-m](https://linkedin.com/in/ehsan-sharafian-m)
- GitHub: [ehsansharafianm](https://github.com/ehsansharafianm)
...
- Built a smartphone-deployed gait assessment system using a single foot-mounted IMU to reconstruct foot-height trajectories, achieving **96.08% locomotion classification accuracy**, **less than 1.1 cm cumulative height error**, and **112 ms latency**.

- Engineered a lightweight human activity recognition system using two IMUs, biomechanical feature extraction, and supervised classifiers including SVM and Naive Bayes, achieving **99.1% accuracy** for normal locomotion and **93.1% accuracy** for atypical stair-negotiation strategies in older adults.
...
# Publications
- **6 peer-reviewed journal articles** (3 first-author) in wearable sensing, biomechanics, rehabilitation engineering, and robotics.

- **Sensors** (2026) – Real-time foot-height estimation and activity classification

- **IEEE Access** (2025) – Lightweight IMU-based activity recognition for older adults

- **IEEE TNSRE** (2025) – Haptic feedback effects on gait and cognitive load

- **Journal of Biomechanics** (2025) – Thigh extension and leg coordination

- **International Journal of Robotics and Automation** (2023) – Trajectory optimization of a robot arm

- **Robotica** (2022) – Screw theory-based constraint wrench analysis
